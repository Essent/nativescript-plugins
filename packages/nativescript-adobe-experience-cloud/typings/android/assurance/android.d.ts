      ...
      export module mobile {
        ...
        export module AssuranceFullScreenTakeover {
          export class FullScreenTakeoverCallbacks {
             ...
             */
            public constructor(implementation: { onURLTriggered(param0: string): boolean; onShow(param0: com.adobe.marketing.mobile.AssuranceFullScreenTakeover): void; onDismiss(param0: com.adobe.marketing.mobile.AssuranceFullScreenTakeover): void });
            public constructor();
            public onShow(param0: com.adobe.marketing.mobile.AssuranceFullScreenTakeover): void;
            public onURLTriggered(param0: string): boolean;
            public onDismiss(param0: com.adobe.marketing.mobile.AssuranceFullScreenTakeover): void;
    ...
    export module marketing {
      export module mobile {
        export class AssurancePlugin {
           ...
           */
          public constructor(implementation: { getVendor(): string; getControlType(): string; onEventReceived(param0: com.adobe.marketing.mobile.AssuranceEvent): void; onRegistered(param0: com.adobe.marketing.mobile.AssuranceSession): void; onSessionConnected(): void; onSessionDisconnected(param0: number): void; onSessionTerminated(): void });
          public constructor();
      ...
      export module mobile {
        ...
        export module AssurancePluginScreenshot {
          export class CaptureScreenShotListener {
             ...
             */
            public constructor(implementation: { onCaptureScreenshot(param0: globalAndroid.graphics.Bitmap): void });
            public constructor();
    ...
    export module marketing {
      export module mobile {
        export class AssuranceSessionLifecycleListener {
           ...
           */
          public constructor(implementation: { onActivityResumed(param0: globalAndroid.app.Activity): void; onActivityDestroyed(param0: globalAndroid.app.Activity): void });
          public constructor();
          public onActivityResumed(param0: globalAndroid.app.Activity): void;
          public onActivityDestroyed(param0: globalAndroid.app.Activity): void;
        }
    ...
    export module marketing {
      export module mobile {
        export class AssuranceSessionURLProvider {
           ...
           */
          public constructor(implementation: { getAuthorizedSessionURL(param0: com.adobe.marketing.mobile.AuthorizedSessionURLCallback): void; onConnectionInitialized(): void; onConnectionSucceeded(): void; onConnectionFinished(): void; onConnectionFailed(param0: com.adobe.marketing.mobile.AssuranceConstants.AssuranceSocketError, param1: boolean): void; isDisplayed(): boolean });
          public constructor();
          public onConnectionInitialized(): void;
          public onConnectionSucceeded(): void;
          public isDisplayed(): boolean;
    ...
    export module marketing {
      export module mobile {
        export class AuthorizedSessionURLCallback {
           ...
           */
          public constructor(implementation: { run(param0: string, param1: com.adobe.marketing.mobile.AssuranceConstants.AssuranceEnvironment): void });
          public constructor();
