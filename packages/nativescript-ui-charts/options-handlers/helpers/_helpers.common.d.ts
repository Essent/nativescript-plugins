export declare const typesMap: {
  ...
  dataPointEvents: (options: any) => any;
  dataPointFunction: (options: any) => HIFunction | com.highsoft.highcharts.core.HIFunction;
  HIHover: (options: any) => any;
  HISelect: (options: any) => any;
  HIInactive: (options: any) => any;
